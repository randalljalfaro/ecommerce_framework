...
class ProductRevisionRevertForm extends ConfirmFormBase {
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('entity.manager')->getStorage('sacra_product'),
  ...
  public function getFormId() {
    return 'sacra_product_revision_revert_confirm';
  }
   ...
   *
   * @param \Drupal\sacra_product\Entity\ProductInterface $revision
   *   The revision to be reverted.
   * @param \Drupal\Core\Form\FormStateInterface $form_state
   *   The current state of the form.
   *
   * @return \Drupal\sacra_product\Entity\ProductInterface
